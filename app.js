...
const PDFJS_CLASSIC_URL = "https://cdnjs.cloudflare.com/ajax/libs/pdf.js/3.11.174/pdf.min.js";
const PDFJS_CLASSIC_WORKER = "https://cdnjs.cloudflare.com/ajax/libs/pdf.js/3.11.174/pdf.worker.min.js";
...
async function loadPdfJs() {
  await loadScript(PDFJS_CLASSIC_URL);
  pdfjsLib = window.pdfjsLib;
  if (!pdfjsLib) throw new Error("PDF.js no quedó disponible en el navegador");
  pdfjsLib.GlobalWorkerOptions.workerSrc = PDFJS_CLASSIC_WORKER;
  return pdfjsLib;
}
